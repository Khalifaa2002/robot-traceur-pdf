...
from src.trajectory_generator import smooth_trajectory, pixel_to_world, add_orientation, save_trajectory
...
def main():
    ...
    original_points = extract_path_from_pdf(str(pdf_path))
    ...
    trajectory = add_orientation(world_points)
